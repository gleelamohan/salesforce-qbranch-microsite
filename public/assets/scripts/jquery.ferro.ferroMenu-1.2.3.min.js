function isMobileOut() {
	if (
		...
		navigator.userAgent.toLowerCase().indexOf('playstation portable') > -1 ||
		...
		ferroMenuCreate: function (t) {
			...
			function A(t) {
				if (a && i.drag) {
					...
					e('#' + E).get(0).style.webkitTransform =
						'translate(' + v + 'px,' + m + 'px)';
					e('#' + E).get(0).style.MozTransform =
						'translate(' + v + 'px,' + m + 'px)';
					e('#' + E).get(0).style.msTransform =
						'translate(' + v + 'px,' + m + 'px)';
					e('#' + E).get(0).style.OTransform =
						'translate(' + v + 'px,' + m + 'px)';
					e('#' + E).get(0).style.transform =
						'translate(' + v + 'px,' + m + 'px)';
					d = true;
					D('menudrag');
				}
				...
				e(r + ' > li').each(function (t) {
					...
					switch (o) {
						...
						case 'center-center':
							...
							var n =
								-Math.PI / 2 + t * ((Math.PI * 2) / e(r).find('li').length);
							var u = i.radius * Math.sin(n);
							var a = i.radius * Math.cos(n);
							break;
					}
			...
			function p() {
				if (
					...
					navigator.userAgent.toLowerCase().indexOf('panasonic') > -1 ||
					navigator.userAgent.toLowerCase().indexOf('philips') > -1 ||
					navigator.userAgent.toLowerCase().indexOf('playstation portable') >
						-1 ||
					navigator.userAgent.toLowerCase().indexOf('proxinet') > -1 ||
					navigator.userAgent.toLowerCase().indexOf('proxinet') > -1 ||
					navigator.userAgent.toLowerCase().indexOf('qtek') > -1 ||
					...
					if (u != null) {
						if (u.hasClass('open')) {
							...
							e(t + ' > li').each(function (t) {
								...
								this.style.webkitTransform =
									'translate(0px,0px) rotate(-' + i.rotation + 'deg)';
								this.style.MozTransform =
									'translate(0px,0px) rotate(-' + i.rotation + 'deg)';
								this.style.msTransform =
									'translate(0px,0px) rotate(-' + i.rotation + 'deg)';
